...
import { Skeleton } from "C:/Users/jasje/Desktop/React Course/next/next-proj/components/ui/skeleton.tsx";
  ...
  return (
    <>
      ...
      <section className="section_container">
        <Image src={post.image} alt="thumbnail" className="rounded-xl" width={183} height={60} />
